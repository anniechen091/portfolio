...
<h3 style="font-size: 17px; margin-bottom: 10px;">[Anticipating Tomorrow: Predicting Radiologist Case Volumes](assets/Anticipating Tomorrow Predicting Radiologist Case Volumes.pdf){:target="_blank"}</h3>
